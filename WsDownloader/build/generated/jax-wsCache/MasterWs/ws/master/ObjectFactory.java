 ...
 * generated in the ws.master package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetArchivoResponseReturn_QNAME = new QName("", "return");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ws.master
     * 
     */
    ...
    public JAXBElement<byte[]> createGetArchivoResponseReturn(byte[] value) {
        return new JAXBElement<byte[]>(_GetArchivoResponseReturn_QNAME, byte[].class, GetArchivoResponse.class, ((byte[]) value));
    }
    ...
    public JAXBElement<byte[]> createGetByteResponseReturn(byte[] value) {
        return new JAXBElement<byte[]>(_GetArchivoResponseReturn_QNAME, byte[].class, GetByteResponse.class, ((byte[]) value));
    }
